    ...
    <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-2 md:grid-cols-4 gap-10">
      ...
      <div className="col-span-2 md:col-span-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="https://www.facebook.com/annayaboutique"
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 rounded-full bg-white/10 hover:bg-gold/80 flex items-center justify-center transition-colors"
            aria-label="Facebook"
        ...
        <ul className="space-y-4">
          <li>
            <a
              ...
              className="flex items-start gap-3 text-white/60 text-sm hover:text-gold transition-colors"
            >
    ...
    <div className="border-t border-white/10 py-5">
      <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/40">
        ...
        <p className="flex items-center gap-1">
          Made by Mohammed Mehraj in Hyderabad
        </p>
